...
```scala
libraryDependencies += "org.akka-js" %%% "akkajstestkit" % "1.2.5.2"
libraryDependencies += "org.akka-js" %%% "akkajsstreamtestkit" % "1.2.5.2"
```


Please note that Akka.js 1.2.5.2 is shipped from the stable Akka 2.5.2.
At this point you can use most of the Akka core Api as described in the official [docs](http://doc.akka.io/docs/akka/2.5.2/scala.html).
