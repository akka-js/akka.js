...
```scala
libraryDependencies += "org.akka-js" %%% "akkajsactor" % "1.2.5.1"
```

If you want to use Akka Stream:
```scala
libraryDependencies += "org.akka-js" %%% "akkajsactorstream" % "1.2.5.1"
```

To test your code you can use:
```scala
libraryDependencies += "org.akka-js" %%% "akkajstestkit" % "1.2.5.1"
libraryDependencies += "org.akka-js" %%% "akkajsstreamtestkit" % "1.2.5.1"
```


Please note that Akka.js 1.2.5.1 is shipped from the stable Akka 2.5.1.
At this point you can use most of the Akka core Api as described in the official [docs](http://doc.akka.io/docs/akka/2.5.1/scala.html).
