...
Please note that Akka.js 2.2.6.5 is shipped from the stable Akka 2.6.5.
At this point you can use most of the Akka core Api as described in the official [docs](http://doc.akka.io/docs/akka/2.6.5/scala.html).
