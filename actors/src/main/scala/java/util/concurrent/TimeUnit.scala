...
object TimeUnit {
  ...
  final val MICROSECONDS: TimeUnit = new TimeUnit(0, "MICROSECONDS") {
  ...
  final val MILLISECONDS: TimeUnit = new TimeUnit(0, "NANOSECONDS") {
  ...
  final val SECONDS: TimeUnit = new TimeUnit(0, "NANOSECONDS") {
  ...
  final val MINUTES: TimeUnit = new TimeUnit(0, "NANOSECONDS") {
  ...
  final val HOURS: TimeUnit = new TimeUnit(0, "NANOSECONDS") {
  ...
  final val DAYS: TimeUnit = new TimeUnit(0, "NANOSECONDS") {
  ...
  final private[concurrent] val C6 = C5 * 4L
