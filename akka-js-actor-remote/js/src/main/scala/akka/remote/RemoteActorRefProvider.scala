 ...
 */
//Scala.Js
protected[akka] class RemoteActorRefProvider(
  ...
  def init(system: ActorSystemImpl): Unit = {
    ...
    val internals = Internals(
      ...
      transport = /*if (remoteSettings.Artery.Enabled) new ArteryTransport(system, this) else*/
        new Remoting(system, this))
