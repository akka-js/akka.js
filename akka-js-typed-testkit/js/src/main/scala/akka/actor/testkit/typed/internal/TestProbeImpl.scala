...
private[akka] object TestProbeImpl {
  ...
  private def testActor[M](queue: java.util.ArrayDeque[M]/*BlockingDeque[M]*/, terminations: java.util.ArrayDeque[Terminated]/*BlockingDeque[Terminated]*/): Behavior[M] =
