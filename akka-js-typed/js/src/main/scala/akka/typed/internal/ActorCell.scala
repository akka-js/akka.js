...
object ActorCell {
  ...
  val statusOffset = 70L//unsafe.objectFieldOffset(classOf[ActorCell[_]].getDeclaredField("_status"))
  val systemQueueOffset = 71L//unsafe.objectFieldOffset(classOf[ActorCell[_]].getDeclaredField("_systemQueue"))
